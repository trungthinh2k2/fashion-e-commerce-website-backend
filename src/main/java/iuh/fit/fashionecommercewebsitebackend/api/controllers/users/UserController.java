...
public class UserController {
    ...
    @FullUpdateResponse
    @PutMapping("/{email}")
    public Response updateUser(@PathVariable String email, @RequestBody @Valid UserUpdateDto userUpdateDto, HttpServletRequest request) {
    ...
    @FullUpdateResponse
    @PutMapping("/upload")
    public Response updateAvatar(@RequestParam("avatar") MultipartFile file, @RequestParam("email") String email) throws IOException {
        return new ResponseSuccess<>(
                HttpStatus.OK.value(),
    ...
    @PatchMapping("/{id}")
    public Response patchUser(@PathVariable Long id, @RequestBody Map<String, ?> data, HttpServletRequest request) {
